    ...
    <div>
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <input id="image_url" type="text" name="image_url" value="<?php echo $Options['image_url']; ?>" />
                </td>
            </tr>    
            <tr valign="top">
                <th scope="row">
                    <label for="submit_button_text">
                        <b>Submit Button Text</b><br />
                        <span class="description">
            ...
            <tr valign="top">
                ...
                <td>
                    <input maxlength="10" id="affiliate_id" type="text" name="affiliate_id" value="<?php echo $Options['affiliate_id']; ?>" />
                </td>
            </tr>      
        </table>
